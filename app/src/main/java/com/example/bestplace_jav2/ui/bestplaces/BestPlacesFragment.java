...
public class BestPlacesFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        notificationsViewModel =
                new ViewModelProvider(this).get(BestPlacesViewModel.class);

        binding = FragmentBestPlacesBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textBestPlaces;
